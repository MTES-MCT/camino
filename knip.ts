const config = {
  "ignore": [".history/**", "packages/api/knexfile.ts", "**/knex/migrations/*", "packages/api/src/knex/migration-stub.ts", "packages/common/src/**/*.test.ts", "packages/api/src/tools/phases/tests-creation.ts", "packages/api/src/**/*.queries.types.ts"],
  "ignoreBinaries": [
  "eslint",
  "prettier",
  "createdb",
