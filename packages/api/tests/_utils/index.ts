...
export const restCall = async <Route extends GetRestRoutes>(pool: Pool, route: Route, params: CaminoRestParams<Route>, user: TestUser | undefined, searchParams?: Record<string, string | string[]>): Promise<request.Test> => {
