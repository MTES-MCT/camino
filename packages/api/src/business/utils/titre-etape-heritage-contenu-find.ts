...
export const heritageContenuFind = (sectionId: string, elementId: string, titreEtape: Pick<ITitreEtape, 'contenu' | 'heritageContenu'>, prevTitreEtape?: Pick<ITitreEtape, 'id' | 'contenu' | "heritageContenu"> | null) => {
