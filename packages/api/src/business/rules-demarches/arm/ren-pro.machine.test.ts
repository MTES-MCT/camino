...
describe('vérifie l’arbre de renonciation et de prolongation d’ARM', () => {
  ...
  test('ne peut pas faire de "mod" après une "mcr"', () => {
    expect(() =>
      ...
      '"Error: cannot execute step: \'{\\"etapeTypeId\\":\\"mod\\",\\"etapeStatutId\\":\\"fai\\",\\"ordre\\":1,\\"date\\":\\"2020-06-30\\"}\' after \'[\\"mfr_fai\\",\\"mdp_fai\\",\\"mcr_fav\\"]\'. The event {\\"type\\":\\"RECEVOIR_MODIFICATION_DE_LA_DEMANDE\\"} should be one of \'DEMANDER_INFORMATION_EXPERTISE_ONF,FAIRE_EXPERTISE_ONF,DESISTER_PAR_LE_DEMANDEUR,CLASSER_SANS_SUITE\'"'
    )
  })
  ...
  test('ne peut pas faire 2 "mco" d’affilée', () => {
    expect(() =>
      ...
      '"Error: cannot execute step: \'{\\"etapeTypeId\\":\\"mca\\",\\"etapeStatutId\\":\\"fai\\",\\"ordre\\":1,\\"date\\":\\"2020-06-30\\"}\' after \'[\\"mfr_fai\\",\\"mdp_fai\\",\\"mca_fai\\"]\'. The event {\\"type\\":\\"DEMANDER_COMPLEMENTS_POUR_RECEVABILITE\\"} should be one of \'RECEVOIR_COMPLEMENTS_POUR_RECEVABILITE,FAIRE_RECEVABILITE_DEMANDE_FAVORABLE,FAIRE_RECEVABILITE_DEMANDE_DEFAVORABLE,DESISTER_PAR_LE_DEMANDEUR\'"'
    )
  })
