            ...
            etapes: [
              {
                ...
                statutId: 'acc',
                ordre: 2,
                isBrouillon: false, date: toCaminoDate('1989-01-02'),
              ...
              },
              {
                ...
                typeId: 'dex',
                statutId: 'acc',
                isBrouillon: false, date: toCaminoDate('1989-01-01'),
                ordre: 1,
              },
            ],
          },
            ...
            etapes: [
              {
                ...
                typeId: 'dpu',
                statutId: 'acc',
                isBrouillon: false, date: toCaminoDate('1989-02-03'),
                ordre: 2,
              },
              {
                ...
                titreDemarcheId: newDemarcheId('h-cx-courdemanges-1989-mut01'),
                typeId: 'dex',
                isBrouillon: false, date: toCaminoDate('1989-02-02'),
                statutId: 'acc',
                ordre: 1,
              },
            ],
            ...
            etapes: [
              {
                ...
                typeId: 'dpu',
                isBrouillon: false, date: toCaminoDate('1986-01-02'),
                statutId: 'acc',
                ordre: 2,
              },
              {
                ...
                typeId: 'dex',
                statutId: 'acc',
                isBrouillon: false, date: toCaminoDate('1986-01-01'),
                ordre: 1,
              },
            ],
          },
            ...
            etapes: [
              {
                ...
                statutId: 'acc',
                ordre: 2,
                isBrouillon: false, date: toCaminoDate('1986-02-02'),
                geojson4326Perimetre: { type: 'Feature', properties: {}, geometry: { type: 'MultiPolygon', coordinates: [[[[1, 2]]]] } },
              },
              {
                ...
                statutId: 'acc',
                ordre: 1,
                isBrouillon: false, date: toCaminoDate('1986-02-01'),
              },
            ],
          },
        ],
            ...
            etapes: [
              {
                ...
                typeId: 'dpu',
                statutId: 'acc',
                isBrouillon: false, date: toCaminoDate('1985-01-01'),
                ordre: 2,
                geojson4326Perimetre: { type: 'Feature', properties: {}, geometry: { type: 'MultiPolygon', coordinates: [[[[1, 2]]]] } },
              },
              {
            ...
            etapes: [
              {
                ...
                statutId: 'acc',
                ordre: 2,
                isBrouillon: false, date: toCaminoDate('1985-02-02'),
                geojson4326Perimetre: { type: 'Feature', properties: {}, geometry: { type: 'MultiPolygon', coordinates: [[[[1, 2]]]] } },
              },
              {
                ...
                statutId: 'acc',
                ordre: 1,
                isBrouillon: false, date: toCaminoDate('1985-02-01'),
              },
            ],
          },
        ],
            ...
            etapes: [
              {
                ...
                statutId: 'rej',
                ordre: 2,
                isBrouillon: false, date: toCaminoDate('1984-01-01'),
                geojson4326Perimetre: { type: 'Feature', properties: {}, geometry: { type: 'MultiPolygon', coordinates: [[[[1, 2]]]] } },
              },
              {
            ...
            etapes: [
              {
                ...
                isBrouillon: false, date: toCaminoDate('1983-01-01'),
            ...
            etapes: [
              {
                ...
                typeId: 'dpu',
                statutId: 'acc',
                isBrouillon: false, date: toCaminoDate('1981-01-01'),
                ordre: 1,
                geojson4326Perimetre: { type: 'Feature', properties: {}, geometry: { type: 'MultiPolygon', coordinates: [[[[1, 2]]]] } },
              },
            ],
            ...
            etapes: [
              {
                ...
                statutId: 'fai',
                ordre: 1,
                isBrouillon: true, date: toCaminoDate('1982-01-01'),
            ...
            etapes: [
              {
                ...
                statutId: 'acc',
                ordre: 1,
                isBrouillon: false, date: toCaminoDate('1982-01-01'),
                dateFin: toCaminoDate('2018-12-31'),
          ...
          etapes: [
            {
              ...
              typeId: 'dpu',
              isBrouillon: false, date: toCaminoDate('2020-01-01'),
              statutId: 'acc',
          ...
          etapes: [
            {
              ...
              titreDemarcheId: newDemarcheId('demarche-id'),
              typeId: 'dpu',
              isBrouillon: false, date: toCaminoDate('2020-01-03'),
              statutId: 'acc',
              contenu: { arm: { mecanisee: true } },
            },
          ],
          ...
          etapes: [
            {
              ...
              titreDemarcheId: newDemarcheId('demarche-id'),
              typeId: 'mfr',
              isBrouillon: true, date: toCaminoDate('2020-01-03'),
              statutId: 'fai',
              contenu: { arm: { mecanisee: true } },
            },
          ],
