export const Domaines = [
    {
        "id": "c",
        "nom": "carrières",
        "description": "Domaine couvrant les zones spéciales de carrières à terre qui incluent des substances minérales ou fossiles de carrières rares ou nécessaires pour satisfaire les besoins des consommateurs et l’intérêt économique national ou régional.",
        "ordre": 3
    },
    {
        "id": "f",
    ...
    },
    {
        "id": "g",
        "nom": "géothermie",
        "description": "Domaine auquel appartiennent les gîtes renfermés dans le sein de la terre dont on peut extraire de l'énergie sous forme thermique, notamment par l'intermédiaire des eaux chaudes et des vapeurs souterraines qu'ils contiennent.",
        "ordre": 7
    },
    {
        "id": "h",
    ...
    },
    {
        ...
        "description": "Domaine minier auquel appartiennent les substances minérales non énergétiques et non radioactives classées dans la catégorie des substances de mines, notemment certains métaux, gaz, sels et terres-rares.",
        "ordre": 1
    },
    {
        "id": "r",
...
export const DOMAINES_IDS = Domaines.map(d => d.id)
