...
export const isAdministrationAdmin = (user: User): user is UserAdmin => userPermissionCheck(user, 'admin') && isNotNullNorUndefined(user?.administrationId)
export const isAdministrationEditeur = (user: User): user is UserEditeur => userPermissionCheck(user, 'editeur') && isNotNullNorUndefined(user?.administrationId)
export const isAdministrationLecteur = (user: User): user is UserLecteur => userPermissionCheck(user, 'lecteur') && isNotNullNorUndefined(user?.administrationId)
