...
const SECTEURS_MARITIME_IDS = [
  ...
  "Côte d'Albâtre et ses ouverts",
  'Baie de Seine',
  'Large baie de Seine',
  'Nord Cotentin',
  'Ouest Cotentin - Baie du Mont Saint-Michel',
  'Manche Ouest au large des îles anglo-normandes',
  'Plaine abyssale',
  'Talus continental',
  'Plateau continental nord',
  'Plateau continental central',
  'Manche occidentale',
  'Golfe normand breton et baie du Mont Saint-Michel',
  'Bretagne nord',
  "Parc naturel marin d'Iroise",
  'Rade de Brest',
  'Bretagne sud',
  'Estuaire de la Loire',
  'Baie de Bourgneuf et littoral vendéen',
  ...
  'Sète',
  'Camargue',
  'Plateau du Golfe du Lion',
  'Côte Bleue',
  'Golfe de Fos-sur-Mer',
  'Rade de Marseille',
  'Périmètre du parc national des Calanques',
  'Littoral varois Ouest',
  'Rade de Toulon',
  'Périmètre du Parc national de Port-Cros',
  'Littoral varois Est',
  'Riviera',
  'Nice et abords',
  'Littoral des Alpes-Maritimes',
  "Large Provence Alpes Côte d'Azur",
  'Plaine bathyale',
  'Canyons du Golfe du Lion',
  "Périmètre du Parc naturel marin du Cap Corse et de l'Agriate",
  'Bastia',
  'Balagne',
  'Scandola',
  'Littoral occidental de la Corse',
  "Golfe d'Ajaccio",
  'Large côte occidental de la Corse',
  'Bouches de Bonifacio Ouest',
  'Bouches de Bonifacio Est - Porto-Vecchio',
  'Plaine orientale et large Est de la Corse',
