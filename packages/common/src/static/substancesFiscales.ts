...
export const SubstancesFiscale: {
  ...
  arge: { id: 'arge', substanceLegaleId: 'arge', uniteId: 'mkc', nom: 'argent', description: 'contenu dans les minerais', openFisca: { nom: 'argentifere' } },
  arse: { id: 'arse', substanceLegaleId: 'arse', uniteId: 'mtk', nom: 'arsenic', description: 'contenu dans les minerais' },
  auru: { id: 'auru', substanceLegaleId: 'auru', uniteId: 'mgr', nom: 'or', description: 'contenu dans les minerais', openFisca: { nom: 'aurifere', unite: 'mkg' } },
  ...
  cfxc: {
    ...
    openFisca: { nom: 'lignites_lt_13' },
  },
  coox: { id: 'coox', substanceLegaleId: 'coox', uniteId: 'vmd', nom: 'gaz carbonique', description: 'extrait à 1 bar et 15 °C', openFisca: { nom: 'gaz_carbonique' } },
  cuiv: { id: 'cuiv', substanceLegaleId: 'cuiv', uniteId: 'mtt', nom: 'cuivre', description: 'contenu dans les minerais' },
  etai: { id: 'etai', substanceLegaleId: 'etai', uniteId: 'mtt', nom: 'étain', description: 'contenu dans les minerais', openFisca: { nom: 'etain' } },
  fera: { id: 'fera', substanceLegaleId: 'ferx', uniteId: 'mtk', nom: 'pyrite de fer', description: 'net livré', openFisca: { nom: 'fer_pyrite' } },
  ferb: { id: 'ferb', substanceLegaleId: 'ferx', uniteId: 'mtk', nom: 'minerais de fer', description: 'net livré', openFisca: { nom: 'fer' } },
  ...
  hyda: {
    ...
    openFisca: { nom: 'bitume_non_distillation' },
  },
  hydb: {
    id: 'hydb',
    substanceLegaleId: 'hydm',
    ...
    openFisca: { nom: 'bitume_distillation' },
  },
  hydc: { id: 'hydc', substanceLegaleId: 'hydx', uniteId: 'mtc', nom: 'pétrole brut', description: 'net extrait', openFisca: { nom: 'petrole_brut' } },
  hydd: { id: 'hydd', substanceLegaleId: 'hydx', uniteId: 'mtt', nom: 'propane et le butane', description: 'net livré', openFisca: { nom: 'propane' } },
  hyde: { id: 'hyde', substanceLegaleId: 'hydx', uniteId: 'mtt', nom: 'essence de dégazolinage', description: 'net livré', openFisca: { nom: 'degazolinage' } },
  hydf: { id: 'hydf', substanceLegaleId: 'hydx', uniteId: 'vmd', nom: 'gaz naturel', description: 'extrait des gisements', openFisca: { nom: 'gaz_naturel' } },
  kclx: { id: 'kclx', substanceLegaleId: 'kclx', uniteId: 'mtc', nom: 'oxyde de potassium', description: 'K2O contenu dans les sels de potassium', openFisca: { nom: 'potassium' } },
  lith: { id: 'lith', substanceLegaleId: 'lith', uniteId: 'mtt', nom: 'oxyde de lithium', description: 'Li2O contenu dans les minerais de lithium', openFisca: { nom: 'lithium' } },
  mang: { id: 'mang', substanceLegaleId: 'mang', uniteId: 'mtc', nom: 'manganèse', description: 'contenu dans les minerais', openFisca: { nom: 'manganese' } },
  moly: { id: 'moly', substanceLegaleId: 'moly', uniteId: 'mtt', nom: 'molybdène', description: 'contenu dans les minerais', openFisca: { nom: 'molybdene' } },
  naca: { id: 'naca', substanceLegaleId: 'nacl', uniteId: 'mtk', nom: 'sel (chlorure de sodium)', description: 'extrait par abattage net livré', openFisca: { nom: 'sel_abattage' } },
  nacb: {
    id: 'nacb',
  ...
  wolf: { id: 'wolf', substanceLegaleId: 'wolf', uniteId: 'mtt', nom: 'oxyde de tungstène (WO3)', description: 'contenu dans les minerais', openFisca: { nom: 'tungstene' } },
