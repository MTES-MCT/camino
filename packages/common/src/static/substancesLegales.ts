...
export const SubstancesLegale: {
  ...
  anti: { id: 'anti', nom: 'antimoine', domaineIds: ['m'] },
  arge: {
    id: 'arge',
    nom: 'argent',
    domaineIds: ['m'],
  ...
  arse: { id: 'arse', nom: 'arsenic', domaineIds: ['m'] },
  auru: {
    id: 'auru',
    nom: 'or',
    domaineIds: ['m'],
  ...
  bery: { id: 'bery', nom: 'béryllium', domaineIds: ['m'] },
  bism: { id: 'bism', nom: 'bismuth', domaineIds: ['m'] },
  cadm: { id: 'cadm', nom: 'cadmium', domaineIds: ['m'] },
  ceri: { id: 'ceri', nom: 'cérium', domaineIds: ['m'] },
  cesi: { id: 'cesi', nom: 'césium', domaineIds: ['m'] },
  chro: {
    id: 'chro',
    nom: 'chrome',
    domaineIds: ['m'],
  ...
  coba: { id: 'coba', nom: 'cobalt', domaineIds: ['m'] },
  coox: {
    id: 'coox',
    nom: 'gaz carbonique',
  ...
  fluo: { id: 'fluo', nom: 'fluorine', domaineIds: ['m'] },
  gall: { id: 'gall', nom: 'gallium', domaineIds: ['m'] },
  geob: {
    id: 'geob',
  ...
  germ: { id: 'germ', nom: 'germanium', domaineIds: ['m'] },
  grap: { id: 'grap', nom: 'graphite', domaineIds: ['m'] },
  grma: {
    id: 'grma',
    nom: 'granulats marins',
    domaineIds: ['w'],
    substanceParentIds: ['sgsc']
  },
  hafn: { id: 'hafn', nom: 'hafnium', domaineIds: ['m'] },
  heli: { id: 'heli', nom: 'hélium', domaineIds: ['m'] },
  hydm: {
    id: 'hydm',
  ...
  hydx: {
    ...
    domaineIds: ['h'],
    substanceParentIds: ['hydr']
  },
  indi: { id: 'indi', nom: 'indium', domaineIds: ['m'] },
  kals: { id: 'kals', nom: 'alun', domaineIds: ['m'] },
  kclx: {
    id: 'kclx',
    ...
    domaineIds: ['m'],
    substanceParentIds: ['selg']
  },
  lith: { id: 'lith', nom: 'lithium', domaineIds: ['m'] },
  mang: {
    id: 'mang',
    nom: 'manganèse',
    domaineIds: ['m'],
  ...
  merc: { id: 'merc', nom: 'mercure', domaineIds: ['m'] },
  moly: { id: 'moly', nom: 'molybdène', domaineIds: ['m'] },
  nacl: {
    id: 'nacl',
    nom: 'sels de sodium',
    description: "A l'état solide ou en dissolution, à l'exception de ceux contenus dans les eaux salées utilisées à des fins thérapeutiques ou de loisirs",
  ...
  niob: { id: 'niob', nom: 'niobium', domaineIds: ['m'] },
  oooo: { id: 'oooo', nom: 'non précisée(s)', domaineIds: ['m'] },
  phos: { id: 'phos', nom: 'phosphates', domaineIds: ['m'] },
  plat: {
    id: 'plat',
    nom: 'platine',
    domaineIds: ['m'],
  ...
  radi: { id: 'radi', nom: 'radium', domaineIds: ['r'] },
  rhen: { id: 'rhen', nom: 'rhénium', domaineIds: ['m'] },
  rubi: { id: 'rubi', nom: 'rubidium', domaineIds: ['m'] },
  rxxx: {
    id: 'rxxx',
    nom: 'autres éléments radioactifs',
    domaineIds: ['r'],
    substanceParentIds: ['polo']
  },
  scan: { id: 'scan', nom: 'scandium', domaineIds: ['m'] },
  scoc: {
    id: 'scoc',
  ...
  sele: { id: 'sele', nom: 'sélénium', domaineIds: ['m'] },
  skst: {
    id: 'skst',
    nom: 'stockage souterrain',
    domaineIds: ['s'],
    substanceParentIds: ['prpa']
  },
  souf: { id: 'souf', nom: 'soufre', domaineIds: ['m'] },
  soxx: {
    id: 'soxx',
    nom: 'sulfates autres que les sulfates alcalino-terreux',
    domaineIds: ['m']
  },
  tant: { id: 'tant', nom: 'tantale', domaineIds: ['m'] },
  tell: { id: 'tell', nom: 'tellure', domaineIds: ['m'] },
  thal: { id: 'thal', nom: 'thallium', domaineIds: ['m'] },
  thor: { id: 'thor', nom: 'thorium', domaineIds: ['r'] },
  tita: {
    id: 'tita',
    nom: 'titane',
    domaineIds: ['m'],
  ...
  trxx: {
    ...
    domaineIds: ['m'],
    substanceParentIds: ['scan']
  },
  uran: { id: 'uran', nom: 'uranium', domaineIds: ['r'] },
  vana: { id: 'vana', nom: 'vanadium', domaineIds: ['m'] },
  wolf: { id: 'wolf', nom: 'tungstène', domaineIds: ['m'] },
  zinc: {
    id: 'zinc',
    nom: 'zinc',
    domaineIds: ['m'],
  ...
  zirc: { id: 'zirc', nom: 'zirconium', domaineIds: ['m'] },
  argc: {
    id: 'argc',
  ...
  hydl: { id: 'hydl', nom: 'hydrocarbures liquides', domaineIds: ['s', 'h'] },
  ...
  selh: { id: 'selh', nom: "sources d'eau salée", domaineIds: [] },
