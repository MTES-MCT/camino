...
const TDE = {
  ...
  [TITRES_TYPES_IDS.PERMIS_EXCLUSIF_DE_RECHERCHES_GEOTHERMIE]: {
    ...
    [DEMARCHES_TYPES_IDS.MutationPartielle]: [ETAPES_TYPES.publicationDeDecisionAuJORF, ETAPES_TYPES.publicationDeDecisionAuRecueilDesActesAdministratifs, ETAPES_TYPES.decisionDeLadministration],
