...
export const EtapesTypes: { [key in EtapeTypeId]: EtapeType<key> } = {
  aac: { id: 'aac', nom: 'avis de direction régionale des affaires culturelles', description: 'Avis sur la situation archéologique du site en question.' },
  aaf: { id: 'aaf', nom: "avis de la direction d'alimentation de l'agriculture et de la forêt", description: 'Avis pour un titre minier.' },
  abd: { id: 'abd', nom: 'abrogation de la décision', description: 'Suppression de l’acte administratif pour l’avenir.' },
  abs: {
    id: 'abs',
  ...
  aca: { id: 'aca', nom: 'avis de la commission des autorisations de recherches minières (CARM)', description: '' },
  acd: { id: 'acd', nom: "avis du conseil départemental de l'environnement et des risques sanitaires et technologiques (Coderst)", description: '' },
  acg: {
    id: 'acg',
  ...
  acl: { id: 'acl', nom: "avis d'une collectivité locale", description: "Avis de la collectivité locale dans le cadre de l’instruction d’un titre ou d'une demande relative à la police des mines." },
  aco: {
    id: 'aco',
  ...
  aep: { id: 'aep', nom: "avis d'un président d'EPCI", description: "Avis du président d’EPCI dans le cadre de l’instruction d’un titre ou d'une demande relative à la police des mines." },
  afp: { id: 'afp', nom: 'avis de la direction régionale des finances publiques', description: 'Avis délivré sur la régularité fiscale de l’entreprise.' },
  agn: { id: 'agn', nom: 'avis de la gendarmerie nationale', description: "Avis sur l'instruction d'un titre minier  ou d'une demande relative à la police des mines " },
  aim: { id: 'aim', nom: "avis de l'Ifremer", description: 'Avis de l’institut français de recherche pour l’exploitation en mer (IFREMER) dans le cadre d’autorisation en mer.' },
  ama: { id: 'ama', nom: "avis d'un maire", description: "Avis du maire, dans le cadre de l’instruction d’un titre ou d'une demande relative à la police des mines." },
  ami: { id: 'ami', nom: 'avis du parc naturel marin', description: 'Avis du parc naturel marin dans le cadre d’autorisation en mer.' },
  and: { id: 'and', nom: 'décision du juge administratif', description: 'Décision à un contentieux ou à un référé.' },
  ane: {
    id: 'ane',
  ...
  aof: { id: 'aof', nom: "avis de l'Office national des forêts", description: 'Avis délivré par l’ONF dans le cadre de l’instruction d’un titre minier.\n' },
  aop: { id: 'aop', nom: "avis de l'Institut national de l'origine et de la qualité", description: '' },
  apd: {
    id: 'apd',
  ...
  api: { id: 'api', nom: "avis de l'état major orpaillage et pêche illicite (EMOPI)", description: 'Avis pour tous les titres miniers en Guyane.' },
  apl: { id: 'apl', nom: "avis d'un service administratif local", description: '' },
  apm: {
    id: 'apm',
  ...
  apn: { id: 'apn', nom: 'avis du parc national', description: "Avis du parc national dans le cadre de l’instruction d’un titre ou d'une demande relative à la police des mines." },
  apo: {
    id: 'apo',
  ...
  apw: { id: 'apw', nom: 'avis du préfet maritime', description: 'Avis pour les titres miniers en mer.' },
  ari: { id: 'ari', nom: 'avis de la réunion interservice', description: '' },
  ars: {
    id: 'ars',
  ...
  asl: { id: 'asl', nom: 'décision du propriétaire du sol', description: '' },
  ass: { id: 'ass', nom: 'avis de la caisse générale de sécurité sociale', description: "Avis émis par le service de la sécurité sociale sur la situation sociale de l'entreprise." },
  auc: {
    id: 'auc',
  ...
  cac: { id: 'cac', nom: 'consultation des administrations centrales', description: '' },
  ...
  cim: { id: 'cim', nom: 'concertation interministérielle', description: 'Concertation prévue dans le cadre des exploitations de granulats marins par les ministères concernés.' },
  cod: { id: 'cod', nom: "saisine du conseil départemental de l'environnement et des risques sanitaires et technologiques  (Coderst)", description: '' },
  cps: { id: 'cps', nom: "confirmation de l'accord du propriétaire du sol", description: '' },
  css: { id: 'css', nom: 'classement sans suite', description: '' },
  dae: { id: 'dae', nom: 'décision de la mission autorité environnementale (examen au cas par cas du projet)', description: '' },
  ...
  dex: { id: 'dex', nom: "décision de l'administration", description: '' },
  dim: {
    id: 'dim',
  ...
  dux: { id: 'dux', nom: 'décision administrative', description: 'Refus ou acceptation à l’issue d’une instruction.' },

  ede: { id: 'ede', nom: 'expertise DREAL ou DGTM service eau', description: 'Instruction de demande sur la réglementation ayant trait à l’eau par les services de la DGTM.\n' },
  edm: { id: 'edm', nom: 'expertise DGTM service prévention des risques et industries extractives (DATE)', description: '' },
  eof: { id: 'eof', nom: "expertise de l'Office national des forêts", description: 'Expertise effectuée par l’ONF dans le cadre d’une demande d’autorisation de recherches minières (ARM).' },
  epc: { id: 'epc', nom: "clôture de l'enquête publique", description: 'L’enquête publique dure un mois. Il est possible de la prolonger. ' },
  epu: {
    id: 'epu',
  ...
  esb: { id: 'esb', nom: 'expertise DREAL ou DGTM service biodiversité', description: 'Instruction de demande sur la réglementation ayant trait à la biodiversité par les services de la DGTM.' },
  ide: { id: 'ide', nom: 'initiation de la démarche de retrait', description: 'Initiative de l’administration qui marque l’engagement d’une démarche de retrait.' },
  ihi: { id: 'ihi', nom: 'informations historiques incomplètes', description: 'Impossibilité de retracer la totalité de la vie administrative du titre.' },
  mca: { id: 'mca', nom: 'demande de compléments (recevabilité de la demande)', description: 'après une mcr' },
  mcb: { id: 'mcb', nom: "demande de compléments (récépissé de déclaration loi sur l'eau)", description: 'après une rde' },
  mcd: { id: 'mcd', nom: 'demande de compléments (décision de la mission autorité environnementale (examen au cas par cas du projet)', description: 'après une dae' },
  mcm: { id: 'mcm', nom: 'demande de compléments (complétude de la demande)', description: 'après une mcp' },
  mco: {
    id: 'mco',
  ...
  mcs: { id: 'mcs', nom: 'demande de compléments (saisine de la CARM)', description: 'après une sca' },
  mdp: {
    id: 'mdp',
  ...
  mec: { id: 'mec', nom: 'avis de demande concurrente', description: 'Annonce à un demandeur qu’une demande concurrente à la sienne a été déposée.' },
  men: {
    id: 'men',
  ...
  meo: { id: 'meo', nom: "prise en charge par l'Office national des forêts", description: '' },
  mfr: {
    id: 'mfr',
    nom: 'demande',
    description:
  ...
  mia: { id: 'mia', nom: "demande d'informations (avis de l'Office national des forêts)", description: 'après une aof' },
  mie: { id: 'mie', nom: "demande d'informations (avis du DREAL, DEAL ou DGTM)", description: 'après une adp' },
  mif: {
    id: 'mif',
  ...
  mim: { id: 'mim', nom: "demande d'informations (recevabilité de la demande)", description: 'après une mcr' },
  mio: { id: 'mio', nom: "demande d'informations (expertise de l'Office national des forêts)", description: 'après une eof' },
  mna: { id: 'mna', nom: 'notification au demandeur (ajournement de la CARM)', description: 'après une aca ajournée' },
  mnb: { id: 'mnb', nom: 'notification au demandeur (avis favorable de la CARM)', description: 'après une aca favorable' },
  mnc: { id: 'mnc', nom: 'notification au demandeur (classement sans suite)', description: 'après une css' },
  mnd: { id: 'mnd', nom: 'notification au demandeur (avis défavorable)', description: 'après une aca défavorable' },
  mni: { id: 'mni', nom: 'notification au demandeur (initiation de la démarche de retrait)', description: 'après une ide' },
  mno: { id: 'mno', nom: 'notification au demandeur', description: 'Notification de la décision au demandeur.' },
  mns: { id: 'mns', nom: 'notification au demandeur (signature de l’autorisation de recherche minière)', description: 'après une sco' },
  mnv: { id: 'mnv', nom: "notification au demandeur (signature de l'avenant à l’autorisation de recherche minière)", description: 'après une aco' },
  mod: {
    id: 'mod',
  ...
  mom: { id: 'mom', nom: 'modification de la demande (décision de la mission autorité environnementale (examen au cas par cas du projet)', description: 'après une dae' },
  ncl: { id: 'ncl', nom: 'notification des collectivités locales', description: 'Notification de la décision aux collectivités locales.' },
  nis: { id: 'nis', nom: 'note interne signalée', description: "Note confidentielle qui permet de faire connaître au sein de l'administration un certain nombre d'informations importantes. \n" },
  npp: { id: 'npp', nom: 'notification au préfet', description: 'Note au préfet demandant de notifier la décision à l’intéressé et de prendre les mesures de publicité nécessaires.' },
  pfc: {
    id: 'pfc',
  ...
  pfd: { id: 'pfd', nom: 'paiement des frais de dossier', description: '' },
  pnr: { id: 'pnr', nom: 'avis du parc naturel régional', description: "Avis du parc naturel régional dans le cadre de l’instruction d’un titre ou d'une demande relative à la police des mines." },
  ppc: {
    id: 'ppc',
  ...
  pqr: { id: 'pqr', nom: 'publication dans un journal local ou national', description: '' },
  rca: { id: 'rca', nom: 'réception de compléments (recevabilité de la demande)', description: 'après une mcr' },
  rcb: { id: 'rcb', nom: "réception de compléments (récépissé de déclaration loi sur l'eau)", description: 'après une rde' },
  rcd: { id: 'rcd', nom: 'réception de compléments (décision de la mission autorité environnementale (examen au cas par cas du projet))', description: 'après une dae' },
  rcg: { id: 'rcg', nom: "rapport du conseil général de l'économie (CGE)", description: '' },
  rcm: { id: 'rcm', nom: 'réception de compléments (complétude de la demande)', description: 'après une mcp' },
  rco: {
    id: 'rco',
  ...
  rcs: { id: 'rcs', nom: 'réception de compléments (saisine de la CARM)', description: 'après une sca' },
  rde: { id: 'rde', nom: "récépissé de déclaration loi sur l'eau", description: 'Document nécessaire à l’utilisation de l’eau dans le cas d’une autorisation de recherches minières (ARM).' },
  ria: { id: 'ria', nom: "réception d'information (avis de l'Office national des forêts)", description: 'après une aof' },
  rie: { id: 'rie', nom: "réception d'information (avis du DREAL, DEAL ou DGTM)", description: 'après une adp' },
  rif: { id: 'rif', nom: "réception d'information", description: "Étape par laquelle le service instructeur reçoit l'information demandée." },
  rim: { id: 'rim', nom: "réception d'information (recevabilité de la demande)", description: 'après une mcr' },
  rio: { id: 'rio', nom: "réception d'information (expertise de l'Office national des forêts)", description: 'après une eof' },
  rpe: { id: 'rpe', nom: 'rapport du Conseil d’État', description: '' },
  rpu: { id: 'rpu', nom: 'publication de décision au recueil des actes administratifs', description: 'Publication, par le préfet, au recueil des actes administratifs.' },
  rtd: { id: 'rtd', nom: 'retrait de la décision', description: 'Sanction administrative consistant à retirer le titre minier dans les cas énumérés dans le code minier.' },
  sas: { id: 'sas', nom: "saisine de l'autorité signataire", description: '' },
  sca: { id: 'sca', nom: 'saisine de la commission des autorisations de recherches minières (CARM)', description: '' },
  scg: {
    id: 'scg',
  ...
  scl: { id: 'scl', nom: 'saisine des collectivités locales', description: 'Consultation pour avis, des collectivités locales dans le cadre de l’instruction d’un titre ou d’une autorisation.' },
  sco: {
    id: 'sco',
  ...
  spp: { id: 'spp', nom: 'saisine du préfet', description: 'L’administration centrale transmet la demande au préfet pour qu’il engage son instruction locale.\n' },
  ssr: {
    id: 'ssr',
  ...
  vfc: { id: 'vfc', nom: 'validation du paiement des frais de dossier complémentaires', description: 'Validation par la direction générale des territoires et des mines (DGTM).' },
  vfd: {
    id: 'vfd',
  ...
  wac: { id: 'wac', nom: 'avis de direction régionale des affaires culturelles - DRAC', description: '' },
  wad: { id: 'wad', nom: 'avis de la direction départementale des territoires et de la mer - DDT(M)', description: '' },
  wae: { id: 'wae', nom: "avis de l'autorité environnementale", description: '' },
  wai: { id: 'wai', nom: 'avis des autres instances', description: '' },
  wal: { id: 'wal', nom: "avis d'un service administratif local", description: '' },
  wam: { id: 'wam', nom: "avis de l'autorité militaire", description: '' },
  wao: { id: 'wao', nom: "arrêté d'ouverture des travaux miniers", description: "Arrêté d'ouverture des travaux miniers" },
  wap: { id: 'wap', nom: 'avis du préfet maritime', description: '' },
  war: { id: 'war', nom: 'avis de réception', description: '' },
  was: { id: 'was', nom: "avis de l'agence régionale de santé - ARS", description: '' },
  wat: { id: 'wat', nom: "avis du conseil départemental de l'environnement et des risques sanitaires et technologiques (Coderst)", description: '' },
  wau: { id: 'wau', nom: 'Avis du demandeur sur les prescriptions proposées', description: '' },
  wce: { id: 'wce', nom: "clôture de l'enquête publique", description: '' },
  wco: { id: 'wco', nom: 'Réception de compléments', description: '' },
  wda: { id: 'wda', nom: 'Donné acte de la déclaration (DOTM)', description: '' },
  wdc: { id: 'wdc', nom: 'demande de compléments (AOTM ou DOTM)', description: '' },
  wdd: { id: 'wdd', nom: 'dépot de la demande', description: '' },
  wde: { id: 'wde', nom: 'demande de compléments (DADT)', description: '' },
  wdm: { id: 'wdm', nom: "décision de l'administration", description: '' },
  wdt: { id: 'wdt', nom: 'avis de la DDT(M)', description: 'avis de la Direction Départementale des Territoires et de la Mer' },
  wfa: { id: 'wfa', nom: "Demande d'autorisation d'ouverture de travaux miniers (AOTM)", description: '' },
  wfd: { id: 'wfd', nom: "Déclaration d'arrêt définitif de travaux (DADT)", description: '' },
  wfo: { id: 'wfo', nom: "Déclaration d'ouverture de travaux miniers (DOTM)", description: '' },
  wfr: { id: 'wfr', nom: "Demande d'autorisation d'ouverture de travaux miniers (DAOTM)", description: '' },
  wmm: { id: 'wmm', nom: "memoire en réponse de l'exploitant (par rapport à l'avis de l'AE)", description: '' },
  wmr: { id: 'wmr', nom: "mémoire en réponse de l'exploitant", description: "mémoire en réponse de l'exploitant à l'avis d'autorité environnementale." },
  wmt: { id: 'wmt', nom: 'memoire de fin de travaux', description: '' },
  woe: { id: 'woe', nom: "ouverture de l'enquête publique", description: '' },
  wpa: { id: 'wpa', nom: 'publication de décision au recueil des actes administratifs', description: '' },
  wpb: { id: 'wpb', nom: 'porter-à-connaissance', description: 'Porter-à-connaissance' },
  wpc: { id: 'wpc', nom: 'Arrêté de prescriptions complémentaires', description: '' },
  wpo: { id: 'wpo', nom: 'Arrêté de second donner acte', description: '' },
  wpp: { id: 'wpp', nom: 'Arrêté préfectoral de premier donner acte (DADT)', description: '' },
  wps: { id: 'wps', nom: 'Arrêté préfectoral de sursis à statuer', description: '' },
  wrc: { id: 'wrc', nom: 'reception de compléments', description: '' },
  wrd: { id: 'wrd', nom: 'Rapport de la Dreal', description: '' },
  wre: { id: 'wre', nom: 'Recevabilité', description: '' },
  wrl: { id: 'wrl', nom: "Avis et rapport du directeur régional chargé de l'environnement, de l'aménagement et du logement", description: '' },
  wrt: { id: 'wrt', nom: 'récolement', description: '' },
  wse: { id: 'wse', nom: "saisine de l'autorité environnementale", description: '' },
  wss: { id: 'wss', nom: "saisine des services de l'Etat", description: '' },
  wtp: { id: 'wtp', nom: 'Transmission du projet de prescriptions au demandeur', description: '' },
}
