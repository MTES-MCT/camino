...
test.each<[TestUser, boolean]>([
  ...
  [{ role: 'entreprise', entreprises: [{ id: entrepriseId, nom: 'nom' }] }, true],
  [{ role: 'bureau dՎtudes', entreprises: [{ id: entrepriseId, nom: 'nom' }] }, true],
  [{ role: 'bureau dՎtudes', entreprises: [{ id: newEntrepriseId('autreEntrepriseId'), nom: 'nom' }] }, false],
...
test.each<[TestUser, boolean]>([
  ...
  [{ role: 'entreprise', entreprises: [{ id: entrepriseId, nom: 'nom' }] }, false],
  [{ role: 'bureau dՎtudes', entreprises: [{ id: entrepriseId, nom: 'nom' }] }, false],
  [{ role: 'bureau dՎtudes', entreprises: [{ id: newEntrepriseId('autreEntrepriseId'), nom: 'nom' }] }, false],
  [{ role: 'bureau dՎtudes', entreprises: [] }, false],
  [{ role: 'defaut' }, false],
