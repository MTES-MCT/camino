...
describe('canReadTitreActivites', () => {
  ...
  test.each<[TestUser, TitreTypeId, AdministrationId[], EntrepriseId[], boolean]>([
    ...
    [{ role: 'bureau dՎtudes', entreprises: [{ id: entrepriseId }] }, TITRES_TYPES_IDS.AUTORISATION_DE_RECHERCHE_METAUX, [], [entrepriseId], false],
    [{ role: 'entreprise', entreprises: [{ id: entrepriseId }] }, TITRES_TYPES_IDS.AUTORISATION_DE_RECHERCHE_METAUX, [], [], false],
    [{ role: 'entreprise', entreprises: [{ id: entrepriseId }] }, TITRES_TYPES_IDS.AUTORISATION_DE_RECHERCHE_METAUX, [], [entrepriseId], true],
...
describe('canEditActivite', () => {
  ...
  test.each<[TestUser, TitreTypeId, AdministrationId[], EntrepriseId[], ActivitesStatutId, boolean]>([
    ...
    [{ role: 'bureau dՎtudes', entreprises: [{ id: entrepriseId }] }, TITRES_TYPES_IDS.AUTORISATION_DE_RECHERCHE_METAUX, [], [entrepriseId], ACTIVITES_STATUTS_IDS.ABSENT, false],
    [{ role: 'entreprise', entreprises: [{ id: entrepriseId }] }, TITRES_TYPES_IDS.AUTORISATION_DE_RECHERCHE_METAUX, [], [], ACTIVITES_STATUTS_IDS.ABSENT, false],
    [{ role: 'entreprise', entreprises: [{ id: entrepriseId }] }, TITRES_TYPES_IDS.AUTORISATION_DE_RECHERCHE_METAUX, [], [entrepriseId], ACTIVITES_STATUTS_IDS.ABSENT, true],
    [{ role: 'entreprise', entreprises: [{ id: entrepriseId }] }, TITRES_TYPES_IDS.AUTORISATION_DE_RECHERCHE_METAUX, [], [entrepriseId], ACTIVITES_STATUTS_IDS.EN_CONSTRUCTION, true],
    [{ role: 'entreprise', entreprises: [{ id: entrepriseId }] }, TITRES_TYPES_IDS.AUTORISATION_DE_RECHERCHE_METAUX, [], [entrepriseId], ACTIVITES_STATUTS_IDS.DEPOSE, false],
    [{ role: 'entreprise', entreprises: [{ id: entrepriseId }] }, TITRES_TYPES_IDS.AUTORISATION_DE_RECHERCHE_METAUX, [], [entrepriseId], ACTIVITES_STATUTS_IDS.CLOTURE, false],
