import { AdministrationRole, AdminUserNotNull, EntrepriseUserNotNull, UserDefaut, UserNotNull, UserSuper, utilisateurIdValidator } from './roles.js'
...
export const testBlankUser: Omit<UserNotNull, 'role'> = {
  id: utilisateurIdValidator.parse('id'),
