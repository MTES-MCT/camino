...
export const PaysList: { [key in PaysId]: Pays<key> } = {
  BL: {
    id: 'BL',
    nom: "Collectivité d'outre-mer de Saint-Barthélemy"
  },
  FR: {
    id: 'FR',
  ...
  GF: {
    id: 'GF',
    nom: 'Département de la Guyane'
  },
  GP: {
    id: 'GP',
    nom: 'Département de la Guadeloupe'
  },
  MF: {
    id: 'MF',
    nom: "Collectivité d'outre-mer de Saint-Martin"
  },
  MQ: {
    id: 'MQ',
    nom: 'Département de la Martinique'
  },
  NC: {
    id: 'NC',
  ...
  PM: {
    id: 'PM',
    nom: 'Collectivité Territoriale de Saint-Pierre-et-Miquelon'
  },
  RE: {
    id: 'RE',
