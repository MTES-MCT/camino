...
const apiClient: Pick<TitreApiClient, 'getTitreCommunes'> = {getTitreCommunes: (titreId) => {
...
export const OnlySecteursMaritimes: StoryFn = () => <Territoires surface={0} forets={[]} titreId='pasDeCommunes' secteursMaritimes={['Balagne', 'Bretagne nord', 'Bretagne sud']} sdomZones={[]}  apiClient={apiClient}/>
...
export const WithError: StoryFn = () => <Territoires apiClient={{ getTitreCommunes: () => Promise.reject(new Error('Chargement impossible des communes'))}} forets={['BEL', 'AMO']} titreId='titreId' secteursMaritimes={[]} />
