...
const titreWithEmptyDemarche: PropsApiClient = {
  ...apiClient,
  getTitreById: (titreIdOrSlug: TitreIdOrSlug) => {
    getTitreAction(titreIdOrSlug)
...
export const TitreWithEmptyDemarche: StoryFn = () => (
  <PureTitre
    currentDemarcheSlug={demarcheSlugValidator.parse('m-ar-crique-adolphe-2023-ret01')}
    initTab="points"
    user={{ ...testBlankUser, role: 'defaut' }}
    router={routerPushMock}
    apiClient={titreWithEmptyDemarche}
    titreIdOrSlug={titre.id}
  />
)
