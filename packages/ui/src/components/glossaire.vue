  ...
  <div>
    ...
    <div class="desktop-blobs">
      ...
      <div class="desktop-blob-2-3">
        <Definition v-if="slug" :slug="slug" :definition="definition" />
        <div v-else>
...
import Definition from './glossaire/definition.vue'
...
watch(
  () => route.params.slug,
  newSlug => {
    const definitionFound = getDefinition(
      Array.isArray(newSlug) ? newSlug[0] : newSlug
    )
    if (definitionFound) {
