<template>
  ...
  >
    <symbol id="icon-checkbox-blank" viewBox="0 0 24 24">
    ...
    <symbol id="icon-marker-cluster" viewBox="0 0 24 24">
    ...
    <symbol id="icon-marker-none" viewBox="0 0 24 24">
    ...
    <symbol id="icon-pattern" viewBox="0 0 24 24">
      <title>pattern</title>
      <path
