...
const apiClient: Pick<ApiClient, 'deleteEtape' | 'deposeEtape' | 'getGeojsonByGeoSystemId'> = {
  deleteEtape: etapeId => {
  ...
  getGeojsonByGeoSystemId: (geojson, systemId) => {
    getGeojsonByGeoSystemIdAction(geojson, systemId)
