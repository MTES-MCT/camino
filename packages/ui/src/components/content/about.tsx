    ...
    <div class="content">
      ...
      <div id="irritants" class="mb-xxl">
        ...
        <div class="desktop-blobs">
          <div class="desktop-blob-1-3">
            ...
            <p>
              Déposer une demande, actualiser les milliers de pages de dossiers papiers, tracer sa demande dans les multiples services de l’État impliqués, faire ses déclarations au bon moment et au
              bon format, sont
      ...
      <div id="utilisateurs" class="mb-xxl">
        ...
        <p class="lead">
          ...
          <br class="hide desktop-static" />
          ouvrir les données aux citoyens et faciliter le travail des agents publics impliqués dans ces projets.
        </p>

        <div class="desktop-blobs">
          <div class="desktop-blob-1-3">
            <div class="p-l">
              <img class={styles.logo} src={business} alt="les entreprises" />
            </div>

            <h3>Les entreprises</h3>

            <p>
              pourront connaitre l’état du domaine minier puis déposer en ligne leurs demandes, les rapports et les données réglementaires. Elles pourront aussi visualiser l’avancement des
          ...
          <div class="desktop-blob-1-3">
            <div class="p-l">
              <img class={styles.logo} src={ngo} alt="Les ONG, les citoyens et leurs élus" />
            </div>

            <h3>Les ONG, les citoyens et leurs élus</h3>

            <p>
              pourront consulter à tout moment les dossiers et les données publiques, à l’échelle de leur territoire pour mieux contribuer, sans précipitation, aux procédures de participation du
              public et suivre de manière transparente l’actualité des projets.
            </p>
          </div>

          <div class="desktop-blob-1-3">
            <div class="p-l">
              <img class={styles.logo} src={userCheck} alt="Les agents publics" />
            </div>

            <h3>Les agents publics</h3>

            <p>
              pourront simplement accéder aux mêmes dossiers et données partagés entre les services des administrations et opérateurs publics. Il sera possible de co-instruire les demandes, de suivre
              et anticiper chaque moment de vie d’un projet, de trouver et valoriser les données sur le domaine minier national simplement et sans intermédiaire.
            </p>
          </div>
        </div>
      </div>
      ...
      <div id="services" class="mb-xxl">
        ...
        <div class="desktop-blobs">
          <div class="desktop-blob-1-3">
            <div class="p-l">
              <img class={styles.logo} src={map} alt="carte interactive" />
            </div>
          ...
          <div class="desktop-blob-1-3">
            <div class="p-l">
              <img class={styles.logo} src={dashboard} alt="tableau de bord" />
            </div>
          ...
          <div class="desktop-blob-1-3">
            <div class="p-l">
              <img class={styles.logo} src={api} alt="une API ouverte" />
            </div>
      ...
      <div id="activites" class="mb-xxl">
        ...
        <div class="tablet-blobs">
          ...
          <div class="tablet-blob-1-2 desktop-blob-1-3 p bg-bg rnd shadow mb">
            ...
            <p>
              Les travaux de recherche ou d’exploitation de substances minières sont encadrés par la police des mines, mission confiée à l’État, qui a pour objet de prévenir et faire cesser les
