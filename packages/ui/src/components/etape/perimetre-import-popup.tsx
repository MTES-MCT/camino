  ...
  const content = () => (
    <form>
      <Alert
        ...
        small={true}
        title={
          <>Vous ne devez déposer que des fichiers ayant un seul multipolygone. Le dépôt csv n'est possible que pour des périmètres simples : un seul polygone sans lacune ayant moins de 20 sommets.</>
        }
      />
