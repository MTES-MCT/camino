...
export const definitions: Definition[] = [
  ...
  },
  {
    ...
    "slug": "titre-minier",
    "ordre": 2,
    "description": "Acte administratif individuel qui octroie des droits miniers exclusifs, pour des substances de mines ou des usages du sous-sol, pour une durée et dans un périmètre fixés. L’autorité décisionnaire est le ministre chargée des mines. Le titre n’inclut pas d’autorisation de travaux miniers.\n\nVous pouvez vous abonner au titre minier pour recevoir des notifications par email à chaque fois qu’une nouvelle étape est ajoutée."
  },
  {
    "id": "tst",
