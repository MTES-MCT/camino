...
export const OuvertParDefaut: StoryFn = () => <Preview apiClient={apiClient} activite={activite} route="fakeRoute" initialOpened={true} />
export const FermeParDefaut: StoryFn = () => <Preview apiClient={apiClient} activite={activite} route="fakeRoute" initialOpened={false} />
...
export const Deposable: StoryFn = () => (
  <Preview apiClient={apiClient} activite={{ ...activite, deposable: true, modification: true, activite_statut_id: ACTIVITES_STATUTS_IDS.EN_CONSTRUCTION }} route="fakeRoute" initialOpened={false} />
)

export const Supprimable: StoryFn = () => (
  <Preview
    apiClient={apiClient}
    activite={{ ...activite, suppression: true, deposable: false, modification: true, activite_statut_id: ACTIVITES_STATUTS_IDS.EN_CONSTRUCTION }}
    route="fakeRoute"
    initialOpened={false}
  />
)
